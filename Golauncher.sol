...
contract ERC20 is Context, IERC20 {
        ...
        returns (bool)
    {
        if (
            ...
            !checkWhiteListed(recipient)
        ) {
            _transfer(_msgSender(), recipient, amount.mul(995).div(1000));
            _burn(_msgSender(), amount.mul(5).div(1000));
        } else {
    ...
    function checkWhiteListed(address _checkAddress)
        ...
        returns (bool)
    {
        return whiteListed[_checkAddress];
    }
    ...
    function transferFrom(
        ...
        if (
            ...
            _transfer(sender, recipient, amount.mul(995).div(1000));
            _burn(sender, amount.mul(5).div(1000));
            _approve(
                sender,
                _msgSender(),
...
contract Golauncher is ERC20 {
    string private _name = "Golauncher";
